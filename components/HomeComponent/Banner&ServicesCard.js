...
const Card = ({
  ...
  var Var = {
    ...
    Variant2: {
      div: { textAlign: 'center', ...ServiceCardStyle },
      margin: { m: 'auto' },
    ...
    >
      ...
      >
        <div sx={{ ...Var[Variant].div }}>
          ...
          {Variant == 'Variant1' ? (
            <Styled.h2 sx={HeadingStyle}>
              {heading}
            </Styled.h2>
          ) : (
            <Styled.h3 sx={HeadingStyle}>
              {heading}
            </Styled.h3>
          )}
          <div
            sx={{
              ...ServiceSeparatorStyle,
              ...Var[Variant].margin,
            }}
          />
          {description ? (
            <Styled.p sx={ServiceTextStyle}>
              {description}
            </Styled.p>
          ) : null}
