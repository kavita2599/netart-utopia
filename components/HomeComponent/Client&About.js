...
const AboutsectionStyle = {
   ...
   backgroundColor: "#000",
    ...
    const AboutPadding={
      p:[null,"50px","350px 0 100px 0","300px 0 100px 0",null,"250px 0 100px 0"]
    }
...
const ClientsOne =({children, header,id,Variant,particle})=>{
  var Var={
    Variant1:{ div: { ...ClientsectionStyle },heading:{...ClientHeadingStyle}},
    Variant2:{ div: { ...AboutsectionStyle ,},heading:{...AboutHeadingStyle}},
}
    return(
